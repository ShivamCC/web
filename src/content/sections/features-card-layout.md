...
list:
  ...
  - icon: "/images/icons/svg/chart.svg" # get outline svg icons from here - https://www.svgrepo.com/vectors/security/outlined/
    ...
    description: From menu setup to offer management, we ensure your brand performs consistently on Swiggy, Zomato. Our team handles day-to-day operations, ensuring accuracy, visibility, and continuous performance improvement.
  ...
  - icon: "/images/icons/svg/customer.svg" # get outline svg icons from here - https://www.svgrepo.com/vectors/security/outlined/
    ...
    description: From menu audits to operational checks, we maintain top-notch accuracy and performance across outlets, ensuring your customers experience the best of your brand every time.
